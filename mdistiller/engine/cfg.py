...
# NormKD_W_DKD CFG
CFG.NormKD_W_DKD = CN()
CFG.NormKD_W_DKD.TEMPERATURE_NORM = 2.0
CFG.NormKD_W_DKD.LOSS = CN()
CFG.NormKD_W_DKD.CE_WEIGHT = 1.0
CFG.NormKD_W_DKD.ALPHA = 1.0
CFG.NormKD_W_DKD.BETA = 8.0
CFG.NormKD_W_DKD.WARMUP = 20
